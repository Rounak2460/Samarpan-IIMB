  ...
  async getOpportunities(filters: {
    ...
    const opportunityList = await db
      .select({
        ...
        coinsReward: opportunities.coinsReward,
  ...
  async getApplicationById(id: string): Promise<ApplicationWithDetails | undefined> {
    const [application] = await db
      .select({
        ...
        opportunityCoinsReward: opportunities.coinsReward,
    ...
    return {
      ...
      opportunity: {
        ...
        coinsReward: application.opportunityCoinsReward,
  ...
  async getApplicationsByUser(userId: string): Promise<ApplicationWithDetails[]> {
    ...
    return userApplications.map(app => ({
      ...
      opportunity: {
        ...
        coinsReward: app.opportunityCoinsReward,
